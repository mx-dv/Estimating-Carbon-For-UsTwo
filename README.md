...
<h2 id ="devIn">User instructions</h2>
 
<p>
    This is currently the same for both developers and users minus the testing. However, we plan to have the extension downloadable from the VScode store for users.
</p>
